...
<string name="google_drive_sync_data_purged">同步从Google云盘清除的数据</string>
<string name="google_drive_sync_data_not_found">在Google云盘中找不到同步数据</string>
<string name="google_drive_sync_data_purge_error">从Google云盘清除同步数据时出错，请尝试重新登录。</string>
<string name="google_drive_login_success">已登录Google云盘</string>
<string name="google_drive_login_failed">无法登录Google云盘: %s</string>
<string name="google_drive_not_signed_in">未登录Google云盘</string>
<string name="error_uploading_sync_data">将同步数据上传到Google云盘时出错</string>
...
<string name="pref_purge_confirmation_message">清除同步数据操作将从Google云盘中删除所有同步数据。你确定要继续吗？</string>
